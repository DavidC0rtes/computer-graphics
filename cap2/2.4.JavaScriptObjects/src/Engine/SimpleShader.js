function simpleShader(vertexShaderID, fragmentShaderID) {
	...
	// Step A: load and compile vertex fragment shaders
	...
	gl.attchShader(this.mCompiledShader, fragmentShader);
	...
	// Step F: Describe the characteristic of vertex position attribute
	...
	SimpleShader.prototype._loadAndCompileShader = function(id, shaderType) {
		...
		if (!gl.getShaderParameter(compiledShader, gl.COMPILE_STATUS)) {
			alert("A shader compiling error ocurred: " + 
